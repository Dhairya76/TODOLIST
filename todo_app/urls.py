...
urlpatterns = [
    ...
    path('add-subtask/<int:pk>/', views.add_subtask, name='add_subtask'),
    path('search-subtask/<int:todo_id>/',
         views.search_subtask, name='search_subtask'),
    path('delete-subtask/<int:subtask_id>/',
